        ...
        <div className="div">
          <RevealAnimation delay={0.2} offset={10}>
            <a
              ...
              className="btn btn-md btn-accent before:hidden  inline-flex items-center gap-2 duration-300 hover:shadow-md shadow-black/5 bg-fr-primary-700  text-white hover:bg-fr-primary-800">
              Inquire
              <svg
