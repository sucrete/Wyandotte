        ...
        <Stack>
          ...
          <Grid columns={3} gap={1} style={{ alignItems: 'center' }}>
            ...
            <Card className="firstCellCard" style={{ paddingLeft: '0px' }}>
              {renderTextField('adultTitle', 'firstCell', '3', { paddingLeft: '0px', fontWeight: '600' })}
              ...
              <Tooltip
                ...
                <span>
                  <MenuButton
                    ...
                    menu={<Menu>{renderTextField('adultTitleDef', 'firstCellButton', '3')}</Menu>}
                    popover={{ portal: false, placement: 'bottom' }}
                  />
                </span>
              </Tooltip>
            </Card>
            <Card>{renderRateField('adult9')}</Card>
            <Card>{renderRateField('adult18')}</Card>

            {/* --- Row 2 --- */}
            <Card className="firstCellCard" style={{ paddingLeft: '0px' }}>
              {renderTextField('seniorStudentTitle', 'firstCell', '3', { paddingLeft: '0px', fontWeight: '600' })}
              ...
              <Tooltip
                ...
                <span>
                  <MenuButton
                    button={renderButton()}
                    id="menu-button-example"
                    menu={<Menu>{renderTextField('seniorStudentTitleDef', 'firstCellButton', '3')}</Menu>}
                    popover={{ portal: false, placement: 'bottom' }}
                  />
                </span>
              </Tooltip>
            </Card>
            <Card>{renderRateField('seniorStudent9')}</Card>
            <Card>{renderRateField('seniorStudent18')}</Card>
