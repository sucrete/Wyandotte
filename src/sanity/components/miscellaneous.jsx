        ...
        <Stack>
          ...
          <Grid columns={3} gap={1} style={{ alignItems: 'center' }}>
            ...
            <Card className="firstCellCard" style={{ paddingLeft: '0px' }}>
              {renderTextField('powerCartTitle', 'firstCell', '3', { paddingLeft: '0px', fontWeight: '600' })}
              ...
              <Tooltip
                ...
                <span>
                  <MenuButton
                    ...
                    menu={<Menu>{renderTextField('powerCartTitleDef', 'firstCellButton', '3')}</Menu>}
                    popover={{ portal: false, placement: 'bottom' }}
                  />
                </span>
              </Tooltip>
            </Card>
            <Card>{renderRateField('powerCart9')}</Card>
            <Card>{renderRateField('powerCart18')}</Card>

            {/* --- Row 2 --- */}
            <Card className="firstCellCard" style={{ paddingLeft: '0px' }}>
              {renderTextField('pullCartTitle', 'firstCell', '3', { paddingLeft: '0px', fontWeight: '600' })}
              ...
              <Tooltip
                ...
                <span>
                  <MenuButton
                    button={renderButton()}
                    id="menu-button-example"
                    menu={<Menu>{renderTextField('pullCartTitleDef', 'firstCellButton', '3')}</Menu>}
                    popover={{ portal: false, placement: 'bottom' }}
                  />
                </span>
              </Tooltip>
            </Card>
            <Card>{renderRateField('pullCart9')}</Card>
            <Card>{renderRateField('pullCart18')}</Card>

            {/* --- Row 3 --- */}
            <Card className="firstCellCard" style={{ paddingLeft: '0px' }}>
              {renderTextField('clubsTitle', 'firstCell', '3', { paddingLeft: '0px', fontWeight: '600' })}
              ...
              <Tooltip
                ...
                <span>
                  <MenuButton
                    button={renderButton()}
                    id="menu-button-example"
                    menu={<Menu>{renderTextField('clubsTitleDef', 'firstCellButton', '3')}</Menu>}
                    popover={{ portal: false, placement: 'bottom' }}
                  />
                </span>
              </Tooltip>
            </Card>
            <Card>{renderRateField('clubs9')}</Card>
            <Card>{renderRateField('clubs18')}</Card>

            {/* --- Row 4 --- */}
            <Card className="firstCellCard" style={{ paddingLeft: '0px' }}>
              {renderTextField('trailFeeTitle', 'firstCell', '3', { paddingLeft: '0px', fontWeight: '600' })}
              ...
              <Tooltip
                ...
                <span>
                  <MenuButton
                    button={renderButton()}
                    id="menu-button-example"
                    menu={<Menu>{renderTextField('trailFeeTitleDef', 'firstCellButton', '3')}</Menu>}
                    popover={{ portal: false, placement: 'bottom' }}
                  />
                </span>
              </Tooltip>
            </Card>
            <Card>{renderRateField('trailFee9')}</Card>
            <Card>{renderRateField('trailFee18')}</Card>
