...
const FacebookIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      ...
      focusable="false"
      className={cn(
        'fill-secondary transition-all duration-500 ease-in-out group-hover:fill-white',
        className,
      )}>
...
const CalendarIcon = ({ className }: { className?: string }) => {
  return (
    <svg
      ...
      fill="none"
      aria-hidden="true"
      className={cn('fill-[#09121F]', className)}>
...
const ThreeDotsIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width={54} height={54} viewBox="0 0 54 54" fill="none">
    <g clipPath="url(#clip0_533_20854)">
      <rect width={54} height={54} rx={27} fill="" className="fill-white" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
  ...
  <div className={cn('absolute top-1/2 -translate-y-1/2 cursor-pointer group z-10', className)}>
    <svg width={36} height={36} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect
        ...
        rx={18}
        fill=""
        className="fill-background-4 group-hover:fill-primary-500 transition-all duration-300 ease-in-out"
      />
      <path
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        className="stroke-[#292929] group-hover:stroke-white transition-all duration-300 ease-in-out"
      />
    </svg>
  </div>
);
